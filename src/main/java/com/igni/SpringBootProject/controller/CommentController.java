package com.igni.SpringBootProject.controller;
...
public class CommentController {
    ...
    public String createComment(@RequestParam(name = "plusComment", required = false) String plusComment,
        ...
        if (isNotEmpty(plusComment)) comments.add(getComment(plusComment, CommentType.PLUS));

        if (isNotEmpty(deltaComment)) comments.add(getComment(deltaComment, CommentType.DELTA));

        if (isNotEmpty(starComment)) comments.add(getComment(starComment, CommentType.STAR));
